...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      ...
      Email: {
        name: "Email",
        url: "mailto:venkteshtapadia0923@gmail.com",
        icon: Icons.email,
        navbar: true,
      },
    },
